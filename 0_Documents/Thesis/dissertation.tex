...
The \texit{availability} $a(i, k)$ accounts for the accumulated evidence for how appropriate it would be for data sample $i$ to choose point $k$ as it exemplar, taking into account the support tfrom other points that point $k$ should be an exemplar for.
