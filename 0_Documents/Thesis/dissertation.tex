...
\Input{
$X$: The set of context embeddings for a word $w$ includeed in a set of $n$ sentences. 
...
%TODO Cite CLSL paper which says that there are many hubs
...
%TODO refer to section with chinese whispers algorihm.
A comparison with other word embeddings such as JoBimText (JBT), and TWSI is conducted.
%TODO cite jobimtext and wikipedia corpus via corwdsourcing
...
%TODO this is one of the early works \cite{melamud16}
...
%TODO Do I have to cite these datasets?
...
%\begin{figure}[H]
%	\center
%  \includegraphics[width=0.7\linewidth]{./assets/relatedwork/cold_fictional_desired.png}
%  \caption{From \cite{coenen19}. \textbf{Fictional} embedding vector points and clusters of \texttt{cold}. This is one of the results that we want to arrive at. }
