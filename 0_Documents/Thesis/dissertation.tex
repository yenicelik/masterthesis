...
\section{BERnie: Making the variances across BERT embeddings more uniform}
...
\begin{figure}[H]
  ...
  This vocabulary $V$ is extended with the additionally introduced split-words.
...
We suspect a bug in loading the model appropriately for the MRPC task, and thus ommited the results for this task.
