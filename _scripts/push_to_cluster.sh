...
rsync -rPz -e 'ssh -p 2223' --exclude '.git/' --exclude 'pictures/' --exclude 'data/' --exclude '_logdump/' --exclude '*.png' --exclude '*.tsv' --exclude 'venv/' --exclude 'analysis/' --exclude '.env' --progress /Users/david/GoogleDrive/_MasterThesis/ david@77.59.149.134:/home/david/_MasterThesis/
